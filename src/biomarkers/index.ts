...
export const biomarkersDictionary = {
  ...
  'S-ALP': (await import('./S-ALP.json')).default as Biomarker,
  ...
  'S-Folate': (await import('./S-Folate.json')).default as Biomarker,
  'S-GGT': (await import('./S-GGT.json')).default as Biomarker,
